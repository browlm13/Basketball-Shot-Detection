...
def xml_to_csv(path):
    ...
    for xml_file in glob.glob(path + '/*.xml'):
        ...
        for member in root.findall('object'):
            ...
            if (value[3] != 'person') and (value[3] != 'basketball'):
                print(value[0])
                print(value[3])
...
def main():
    ...
    class_name = "person_basketball_dataset_v1"
    filename = class_name + '.csv'
    full_csv_filepath = "person_basketball_dataset_v1/csv_records/" + filename
    train_csv_filepath = "person_basketball_dataset_v1/csv_records/train_labels.csv"
    test_csv_filepath = "person_basketball_dataset_v1/csv_records/test_labels.csv"
    ratio_train_images = .9  #90%

    # generate csv file for entire image set
    annotations_path = os.path.join(os.getcwd(), 'person_basketball_dataset_v1/annotations')
